  ...
  const sections = [
    ...
    },
    {
      ...
      body: [
        ...
        "מסלול פרימיום בחיוב חודשי או חד-פעמי, מסלול מקצועי בחיוב חודשי.",
        "ניתן לבטל בכל רגע דרך עמוד ההגדרות. ביטול תקף מהמחזור הבא — לא נחזיר חיוב על מחזור פעיל.",
        "ערבות שביעות רצון של 30 יום ממועד החיוב הראשון — נחזיר את כל הסכום אם לא היית מרוצה.",
      ],
    },
    {
